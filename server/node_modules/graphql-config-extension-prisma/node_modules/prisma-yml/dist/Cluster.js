...
var Cluster = /** @class */ (function () {
    function Cluster(out, name, baseUrl, clusterSecret, local, shared) {
    ...
    Cluster.prototype.getLocalToken = function () {
        if (!this.clusterSecret || this.clusterSecret === '') {
            var localNote = Environment_1.isLocal(this.baseUrl)
                ? "Please either provide a clusterSecret or run " + chalk_1.default.green.bold('prisma local start') + " to generate a new one. "
                : '';
            this.out.warn("Property '" + chalk_1.default.bold('clusterSecret') + "' of cluster " + chalk_1.default.bold(this.name) + " in ~/.prisma/config.yml is empty. " + localNote + "Read more here https://bit.ly/prisma-graphql-config-yml");
            return null;
        }
        if (!this.cachedToken) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        debug('generateClusterToken', constants_1.cloudApiEndpoint);
