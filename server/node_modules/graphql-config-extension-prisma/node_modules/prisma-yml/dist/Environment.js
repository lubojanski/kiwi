...
var Environment = /** @class */ (function () {
    ...
    Environment.prototype.getClusters = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var res, json, clusters, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.globalRC.cloudSessionKey) return [3 /*break*/, 5];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                    ...
                    case 3:
                        ...
                        if (json &&
                            ...
                            clusters = _.flattenDeep(json.data.me.memberships.map(function (m) { return m.workspace.clusters; }));
                            clusters
                                .filter(function (c) { return ['prisma-eu1', 'prisma-us1'].includes(c.name); })
                                .forEach(function (cluster) {
                                _this.addCluster(new Cluster_1.Cluster(_this.out, cluster.name, cluster.connectInfo.endpoint, _this.globalRC.cloudSessionKey, false, false));
                            });
    ...
    Environment.prototype.getLocalClusterConfig = function () {
        ...
        return this.clusters
            .filter(function (c) { return !c.shared && c.clusterSecret !== _this.cloudSessionKey; })
