...
var GraphQLServer = /** @class */ (function () {
    function GraphQLServer(props) {
        ...
        if (props.schema) {
            ...
            var directiveResolvers = props.directiveResolvers, typeDefs = props.typeDefs, resolvers = props.resolvers;
    ...
    GraphQLServer.prototype.start = function (optionsOrCallback, callback) {
        ...
        if (this.options.playground) {
            var playgroundOptions = this.options.subscriptions
                ? {
        ...
        return new Promise(function (resolve, reject) {
            if (!_this.options.subscriptions) {
                app.listen(_this.options.port, function () {
                    callbackFunc(_this.options);
                    resolve();
                });
            }
            else {
                var combinedServer_1 = http_1.createServer(app);
                ...
                _this.subscriptionServer = subscriptions_transport_ws_1.SubscriptionServer.create({
                    ...
                    onConnect: function (connectionParams, webSocket) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    path: _this.options.subscriptions,
                });
            }
        });
    };
