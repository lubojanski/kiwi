...
var BatchedGraphQLClient = /** @class */ (function () {
    function BatchedGraphQLClient(uri, options) {
        ...
        this.load = function (keys) { return __awaiter(_this, void 0, void 0, function () {
            var requests, body, response, results, allResultsHaveData, errorIndex, result, errorResult;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (Array.isArray(results)) {
                            allResultsHaveData = results.filter(function (r) { return r.data; }).length === results.length;
                            if (response.ok && !results.find(function (r) { return r.errors; }) && allResultsHaveData) {
                                return [2 /*return*/, results.map(function (r) { return r.data; })];
                            }
                            else {
                                errorIndex = results.findIndex(function (r) { return r.errors; });
